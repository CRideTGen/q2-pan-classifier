...
def main():
    with open(args.config, 'r') as cf:
        ...
        build_cmd = ['bash', '/home/linux_subsys/PycharmProjects/q2-pan-classifier/test_script.sh',
                     config_loaded['query_string'], config_loaded['forward_primer'],
                     config_loaded['reverse_primer'], config_loaded['min_length'], config_loaded['max_length']]
        #print(build_cmd)
        ...
        viral_sequences = import_viral_sequences('/home/linux_subsys/PycharmProjects/q2-pan-classifier/script_test_dir/CoronaVirus/manifest')

        forward_primer = "GGTTGGGAYTAYCCHAARTGYGA"
        reverse_primer = "CCRTCATCASWHARWATCAT"
        #need to unpack the strings into a list of characters
